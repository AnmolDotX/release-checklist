...
This application is a release checklist tool that could help developers with their release process. Here are the mockups: [releasecheck.png](https://public-swap.s3.us-east-1.amazonaws.com/releasecheck.png)
...
Submit here: [Submission Form](https://forms.gle/ER387znmXfN4MvzdA)
